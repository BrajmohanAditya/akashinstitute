...
import { createCourse, getAllPurchasedCourse, getCourse, getSingleCourse, getSinglePurchasedCourse } from '../controllers/course.controller.js'
...
courseRoute.get('/getSinglePurchasedCourse/:id', protectRoute, getSinglePurchasedCourse)
